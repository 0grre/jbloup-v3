...
async function fetchData() {
  try {
    ...
    data.value = JSON.parse(gist.files[fileName].content);
  ...
  <section class="mx-auto min-h-screen max-w-screen-xl px-6 py-12 font-museo md:px-12 md:py-20 lg:px-24 lg:py-0">
    <div class="lg:flex lg:justify-between lg:gap-4">
      <header class="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
        <div><h1 class="text-4xl font-bold tracking-tight text-zinc-200 sm:text-5xl"><a href="/">JB Loup</a>
        </h1>
          <h2 class="mt-3 text-lg font-medium tracking-tight text-zinc-200 sm:text-xl">Développeur Backend chez
            Wokine</h2>
          ...
          <nav class="nav hidden lg:block" aria-label="In-page jump links">
            <ul class="mt-16 w-max">
              <li><a class="group flex items-center py-3 active" href="#about"><span
                  class="nav-indicator mr-4 h-px w-8 bg-zinc-600 transition-all group-hover:w-16 group-hover:bg-zinc-200 group-focus-visible:w-16 group-focus-visible:bg-zinc-200 motion-reduce:transition-none"></span><span
                  class="nav-text text-xs font-bold uppercase tracking-widest text-zinc-500 group-hover:text-zinc-200 group-focus-visible:text-zinc-200">About</span></a>
              </li>
              <li><a class="group flex items-center py-3 " href="#experience"><span
                  class="nav-indicator mr-4 h-px w-8 bg-zinc-600 transition-all group-hover:w-16 group-hover:bg-zinc-200 group-focus-visible:w-16 group-focus-visible:bg-zinc-200 motion-reduce:transition-none"></span><span
                  class="nav-text text-xs font-bold uppercase tracking-widest text-zinc-500 group-hover:text-zinc-200 group-focus-visible:text-zinc-200">Experience</span></a>
              </li>
              <li><a class="group flex items-center py-3 " href="#projects"><span
                  class="nav-indicator mr-4 h-px w-8 bg-zinc-600 transition-all group-hover:w-16 group-hover:bg-zinc-200 group-focus-visible:w-16 group-focus-visible:bg-zinc-200 motion-reduce:transition-none"></span><span
                  class="nav-text text-xs font-bold uppercase tracking-widest text-zinc-500 group-hover:text-zinc-200 group-focus-visible:text-zinc-200">Projects</span></a>
              </li>
            </ul>
          </nav>
        </div>
        <ul class="ml-1 mt-8 flex items-center" aria-label="Social media">
          <li class="mr-5 text-xs shrink-0"><a class="block hover:text-zinc-200" href="https://github.com/bchiang7"
          ...
          <li class="mr-5 text-xs shrink-0"><a class="block hover:text-zinc-200" href="https://codepen.io/bchiang7"
                                               target="_blank" rel="noreferrer noopener"
                                               aria-label="CodePen (opens in a new tab)" title="CodePen"><span
              class="sr-only">CodePen</span>
          ...
          <li class="mr-5 text-xs shrink-0"><a class="block hover:text-zinc-200" href="https://instagram.com/bchiang7"
                                               target="_blank" rel="noreferrer noopener"
          ...
          <li class="mr-5 text-xs shrink-0"><a class="block hover:text-zinc-200" href="https://twitter.com/bchiang7"
                                               target="_blank" rel="noreferrer noopener"
                                               aria-label="Twitter (opens in a new tab)" title="Twitter"><span
      ...
      <main id="content" class="pt-24 lg:w-1/2 lg:py-24">
        <section ref="about" id="about"
                 :class="{ active: currentSection === 'experience' } + 'mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24'"
                 aria-label="About me">
          <div
              class="sticky top-0 z-20 -mx-6 mb-4 w-screen bg-zinc-900/75 px-6 py-5 backdrop-blur md:-mx-12 md:px-12 lg:sr-only lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0 lg:opacity-0">
            <h2 class="text-sm font-bold uppercase tracking-widest text-zinc-200 lg:sr-only">About</h2></div>
          <div><p class="mb-4">Back in 2012, I decided to try my hand at creating custom Tumblr themes and tumbled head
            first into the rabbit hole of coding and web development. Fast-forward to today, and I’ve had the privilege
            of building software for an.</p></div>
          <pre>{{ data }}</pre>
        </section>
        <section ref="experience" id="experience"
          ...
          <div
              class="sticky top-0 z-20 -mx-6 mb-4 w-screen bg-zinc-900/75 px-6 py-5 backdrop-blur md:-mx-12 md:px-12 lg:sr-only lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0 lg:opacity-0">
            <h2 class="text-sm font-bold uppercase tracking-widest text-zinc-200 lg:sr-only">Experience</h2></div>
          <div>
            <ol class="group/list">
              <li class="mb-12">
                <div
                  ...
                  <div
                      class="absolute -inset-x-4 -inset-y-4 z-0 hidden transition motion-reduce:transition-none lg:-inset-x-6 lg:block lg:group-hover:bg-zinc-800/50 lg:group-hover:shadow-[inset_0_1px_0_0_rgba(148,163,184,0.1)] lg:group-hover:drop-shadow-lg"></div>
                  <header
                      class="z-10 mb-2 mt-1 text-xs font-semibold uppercase tracking-wide text-zinc-500 sm:col-span-2"
                      aria-label="2018 to Present">2018 — Present
                  </header>
                  <div class="z-10 sm:col-span-6">
                    <h3 class="font-medium leading-snug text-zinc-200">
                      <div><a
                          class="inline-flex items-baseline font-medium leading-tight text-zinc-200 hover:text-yellow-300 focus-visible:text-yellow-300  group/link text-base"
                        ...
                        <!-- --> <span class="inline-block">Upstatement<svg xmlns="http://www.w3.org/2000/svg"
                                                                            viewBox="0 0 20 20" fill="currentColor"
                                                                            class="inline-block h-4 w-4 shrink-0 transition-transform group-hover/link:-tranzinc-y-1 group-hover/link:tranzinc-x-1 group-focus-visible/link:-tranzinc-y-1 group-focus-visible/link:tranzinc-x-1 motion-reduce:transition-none ml-1 tranzinc-y-px"
                                                                            aria-hidden="true"><path fill-rule="evenodd"
                                                                                                     d="M5.22 14.78a.75.75 0 001.06 0l7.22-7.22v5.69a.75.75 0 001.5 0v-7.5a.75.75 0 00-.75-.75h-7.5a.75.75 0 000 1.5h5.69l-7.22 7.22a.75.75 0 000 1.06z"
                                                                                                     clip-rule="evenodd"></path></svg></span></span></a>
                      </div>
                      <div>
                        <div class="text-zinc-500" aria-hidden="true">Senior Engineer</div>
                      </div>
                      <div>
                        <div class="text-zinc-500" aria-hidden="true">Engineer</div>
                      </div>
                    </h3>
                    <p class="mt-2 text-sm leading-normal">Build, style, and ship high-quality websites, design systems,
                      mobile apps, and digital experiences for a diverse array of projects for clients including Harvard
                      Business School, Everytown for Gun Safety, Pratt Institute, Koala Health, Vanderbilt University,
                      The 19th News, and more. Provide leadership within engineering department through close
                      collaboration, knowledge shares, and spearheading the development of internal tools.</p>
                    <ul class="mt-2 flex flex-wrap" aria-label="Technologies used">
                      <li class="mr-1.5 mt-2">
                        <div
                            class="flex items-center rounded-full bg-yellow-400/10 px-3 py-1 text-xs font-medium leading-5 text-yellow-300 ">
                          JavaScript
                        </div>
                      </li>
                      <li class="mr-1.5 mt-2">
                  ...
                  <div class="z-10 sm:col-span-6">
                    <h3 class="font-medium leading-snug text-zinc-200">
                      <div><a
                        ...
                        <!-- --> <span class="inline-block">Apple<svg xmlns="http://www.w3.org/2000/svg"
                                                                      viewBox="0 0 20 20" fill="currentColor"
                                                                      class="inline-block h-4 w-4 shrink-0 transition-transform group-hover/link:-tranzinc-y-1 group-hover/link:tranzinc-x-1 group-focus-visible/link:-tranzinc-y-1 group-focus-visible/link:tranzinc-x-1 motion-reduce:transition-none ml-1 tranzinc-y-px"
                                                                      aria-hidden="true"><path fill-rule="evenodd"
                                                                                               d="M5.22 14.78a.75.75 0 001.06 0l7.22-7.22v5.69a.75.75 0 001.5 0v-7.5a.75.75 0 00-.75-.75h-7.5a.75.75 0 000 1.5h5.69l-7.22 7.22a.75.75 0 000 1.06z"
                    ...
                    <ul class="mt-2 flex flex-wrap" aria-label="Related links">
                      <li class="mr-4"><a
                          class="relative mt-2 inline-flex items-center text-sm font-medium text-zinc-300 hover:text-yellow-300 focus-visible:text-yellow-300"
                  ...
                  <div class="z-10 sm:col-span-6">
                    <h3 class="font-medium leading-snug text-zinc-200">
                      <div><a
                        ...
                        <!-- --> <span class="inline-block">Studio<svg xmlns="http://www.w3.org/2000/svg"
                                                                       viewBox="0 0 20 20" fill="currentColor"
                                                                       class="inline-block h-4 w-4 shrink-0 transition-transform group-hover/link:-tranzinc-y-1 group-hover/link:tranzinc-x-1 group-focus-visible/link:-tranzinc-y-1 group-focus-visible/link:tranzinc-x-1 motion-reduce:transition-none ml-1 tranzinc-y-px"
                                                                       aria-hidden="true"><path fill-rule="evenodd"
                                                                                                d="M5.22 14.78a.75.75 0 001.06 0l7.22-7.22v5.69a.75.75 0 001.5 0v-7.5a.75.75 0 00-.75-.75h-7.5a.75.75 0 000 1.5h5.69l-7.22 7.22a.75.75 0 000 1.06z"
                  ...
                  <div class="z-10 sm:col-span-6">
                    <h3 class="font-medium leading-snug text-zinc-200">
                      <div><a
                        ...
                        <!-- --> <span class="inline-block">Starry<svg xmlns="http://www.w3.org/2000/svg"
                                                                       viewBox="0 0 20 20" fill="currentColor"
                                                                       class="inline-block h-4 w-4 shrink-0 transition-transform group-hover/link:-tranzinc-y-1 group-hover/link:tranzinc-x-1 group-focus-visible/link:-tranzinc-y-1 group-focus-visible/link:tranzinc-x-1 motion-reduce:transition-none ml-1 tranzinc-y-px"
                                                                       aria-hidden="true"><path fill-rule="evenodd"
                                                                                                d="M5.22 14.78a.75.75 0 001.06 0l7.22-7.22v5.69a.75.75 0 001.5 0v-7.5a.75.75 0 00-.75-.75h-7.5a.75.75 0 000 1.5h5.69l-7.22 7.22a.75.75 0 000 1.06z"
                  ...
                  <div class="z-10 sm:col-span-6">
                    <h3 class="font-medium leading-snug text-zinc-200">
                      <div><a
                        ...
                        <!-- --> <span class="inline-block">U.S.<svg xmlns="http://www.w3.org/2000/svg"
                                                                     viewBox="0 0 20 20" fill="currentColor"
                                                                     class="inline-block h-4 w-4 shrink-0 transition-transform group-hover/link:-tranzinc-y-1 group-hover/link:tranzinc-x-1 group-focus-visible/link:-tranzinc-y-1 group-focus-visible/link:tranzinc-x-1 motion-reduce:transition-none ml-1 tranzinc-y-px"
                                                                     aria-hidden="true"><path fill-rule="evenodd"
                                                                                              d="M5.22 14.78a.75.75 0 001.06 0l7.22-7.22v5.69a.75.75 0 001.5 0v-7.5a.75.75 0 00-.75-.75h-7.5a.75.75 0 000 1.5h5.69l-7.22 7.22a.75.75 0 000 1.06z"
                    ...
                    <p class="mt-2 text-sm leading-normal">Developed, maintained, and shipped production code for client
                      websites. Clients included JetBlue, Lovesac, U.S. Cellular, U.S. Department of Defense, and
                      more.</p>
                    <ul class="mt-2 flex flex-wrap" aria-label="Technologies used">
                      <li class="mr-1.5 mt-2">
                        <div
            ...
            <div class="mt-12"><a
                ...
                aria-label="View Full Résumé (opens in a new tab)"><span>View Full<!-- --> <span class="inline-block">Résumé<svg
        ...
        <footer class="max-w-md pb-16 text-sm text-zinc-500 sm:pb-0"><p>Loosely designed in<!-- --> <a
            href="https://www.figma.com/"
            class="font-medium text-zinc-400 hover:text-yellow-300 focus-visible:text-yellow-300" target="_blank"
            rel="noreferrer noopener" aria-label="Figma (opens in a new tab)">Figma</a> <!-- -->and coded in<!-- --> <a
            href="https://code.visualstudio.com/"
            class="font-medium text-zinc-400 hover:text-yellow-300 focus-visible:text-yellow-300" target="_blank"
            rel="noreferrer noopener" aria-label="Visual Studio Code (opens in a new tab)">Visual Studio Code</a>
          <!-- -->by yours truly. Built with<!-- --> <a href="https://nextjs.org/"
                                                        class="font-medium text-zinc-400 hover:text-yellow-300 focus-visible:text-yellow-300"
                                                        target="_blank" rel="noreferrer noopener"
          ...
          and<!-- --> <a href="https://tailwindcss.com/"
            ...
            CSS</a>, deployed with<!-- --> <a href="https://vercel.com/"
                                              class="font-medium text-zinc-400 hover:text-yellow-300 focus-visible:text-yellow-300"
                                              target="_blank" rel="noreferrer noopener"
                                              aria-label="Vercel (opens in a new tab)">Vercel</a>. All text is set in
          the<!-- --> <a href="https://rsms.me/inter/"
                         class="font-medium text-zinc-400 hover:text-yellow-300 focus-visible:text-yellow-300"
