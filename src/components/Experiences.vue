...
<template>
  <section ref="experience" id="experience" :class="'mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24'" aria-label="Work experience">
    ...
    <div>
      <ol class="group/list">
        <li class="mb-12" v-for="experience in work">
          <div
